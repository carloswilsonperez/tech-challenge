...
async function fetchMetaData() {
  ...
  then(data => {
    ...
    function makeList(listData) {
        ...
        listContainer = document.getElementById('render_movies');
        ...
        for (i = 0; i < numberOfListItems; ++i) {
            ...
            divItemRow = document.createElement('div');

            divItemOverview = document.createElement('div');
            divItemDetail = document.createElement('div');
    ...
    function bindHover() {
        ...
        container.onmouseover = function(event) {
            ...
            if (event.target.className === 'thumbnail') {
                ...
                imdbItem = document.createElement('div');
